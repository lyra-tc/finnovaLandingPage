    ...
    <div class="w-full px-6 sm:px-10 lg:px-16 py-10 md:py-12">
      <div class="mx-auto w-full max-w-screen-2xl">
        ...
        >
          ...
          <!-- Col 2 -->
          <nav class="w-full flex flex-col items-center justify-center space-y-3 text-sm lg:items-start">
            <a href="#inicio" class="link-underline text-white/80 hover:text-white/80"
               @click="(e) => goToHashWithAnim(e, '#inicio')">
              INICIO
            </a>
            <a href="#nosotros" class="link-underline text-white/80 hover:text-white/80"
               @click="(e) => goToHashWithAnim(e, '#nosotros')">
              NOSOTROS
            </a>
            <a href="#funcionamiento" class="link-underline text-white/80 hover:text-white/80"
               @click="(e) => goToHashWithAnim(e, '#funcionamiento')">
              FUNCIONAMIENTO
            </a>
            <a href="#waitlist" class="link-underline text-white/80 hover:text-white/80"
          ...
          <div class="w-full flex flex-col items-center justify-center space-y-4">
            ...
            <div class="flex items-center justify-center gap-4">
              <a class="group grid h-10 w-10 place-items-center rounded-full border border-white/30
             text-white/80 transition-all duration-300
             hover:border-[#0FD985] hover:text-[#0FD985]">
                <Icon icon="fa6-brands:facebook-f" class="h-4 w-4 translate-y-[0.5px]" />
              </a>

              <a href="https://www.instagram.com/lyratech/" target="_blank"
                  class="group grid h-10 w-10 place-items-center rounded-full border border-white/30
             text-white/80 transition-all duration-300
             hover:border-[#0FD985] hover:text-[#0FD985]">
                <Icon icon="fa6-brands:instagram" class="h-4 w-4" />
              </a>

              <a href="https://wa.me/525564075229" target="_blank"
                  class="group grid h-10 w-10 place-items-center rounded-full border border-white/30
             text-white/80 transition-all duration-300
             hover:border-[#0FD985] hover:text-[#0FD985]">
